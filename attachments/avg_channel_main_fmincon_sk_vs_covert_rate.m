...
for experiment=1:length(optimizations_P_X2)    
    ...
    if (experiment == 1) 
        W_Y_X1_X2_0 = [0.35, 0.11, 0.31, 0.23; 0.35, 0.11, 0.31, 0.23 ; 0.51, 0.02, 0.17, 0.30; 0.35, 0.11, 0.31, 0.23];   %% first X2_cardinality rows for x1=0 and latter for  x1=1 
        W_Y_X1_X2_1 = [0.03, 0.56, 0.4, 0.01; 0.35, 0.11, 0.31, 0.23; 0.04,0.33, 0.62, 0.01; 0.35, 0.11, 0.31, 0.23];   %% first X2_cardinality rows for x1=0 and latter for  x1=1 
    
        W_Y_X1_X2 = lambda_avg_channel*W_Y_X1_X2_0 + (1-lambda_avg_channel)*W_Y_X1_X2_1 ;
        
        W_Z_X1_X2_0 = [ 0.3, 0.5, 0.08, 0.12; 0.35, 0.11, 0.31, 0.23; 0.16, 0.28, 0.37, 0.19; 0.35, 0.11, 0.31, 0.23];  %% first X2_cardinality rows for x1=0 and latter for  x1=1
        W_Z_X1_X2_1 = [0.21, 0.32, 0.39, 0.08; 0.35, 0.11, 0.31, 0.23; 0.48, 0.1, 0.38, 0.04; 0.35, 0.11, 0.31, 0.23];  %% first X2_cardinality rows for x1=0 and latter for  x1=1
    
        W_Z_X1_X2 = lambda_avg_channel*W_Z_X1_X2_0 + (1-lambda_avg_channel)*W_Z_X1_X2_1;
